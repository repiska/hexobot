(ns chatbot.adapters.max.keyboards
  "Клавиатуры MAX. Делегируют к chatbot.domain.messages.
   Фактическая конвертация в формат MAX происходит в api.clj/build-keyboard."
  (:require [chatbot.domain.messages :as msg]))

;; ============================================
;; ВСПОМОГАТЕЛЬНЫЕ ХЕЛПЕРЫ (MAX-specific)
;; ============================================
